        ...
        <main className="flex min-h-screen items-center justify-center bg-slate-50 px-5 py-10">
            <div className="w-full max-w-2xl">
                <div className="mb-8 text-center">
                    <div className="mx-auto mb-4 flex size-14 items-center justify-center rounded-xl bg-teal-700">
                        <Building2 className="size-7 text-white" />
                    </div>
                    <h1 className="text-2xl font-bold text-slate-900">Select Location</h1>
                    <p className="mt-1 text-xs font-semibold uppercase tracking-widest text-teal-700">IS-C · MedStock HIS</p>
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                    {locations.map((loc) => (
                        <button
                            ...
                            className="flex items-center gap-4 rounded-xl border-2 border-slate-200 bg-white p-5 text-left transition hover:border-teal-500 hover:bg-teal-50 hover:shadow-sm"
                        >
                            <div className="flex size-12 shrink-0 items-center justify-center rounded-lg bg-teal-100 text-teal-700">
                ...
                {isAdmin && onOverview && (
                    <div className="mt-6 text-center">
                        <button type="button" onClick={onOverview}
                            ...
                            <LayoutDashboard className="size-4 text-teal-700" />
